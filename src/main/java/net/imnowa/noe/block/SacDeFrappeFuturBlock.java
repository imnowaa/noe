...
public class SacDeFrappeFuturBlock extends Block {
	public static final DirectionProperty FACING = HorizontalBlock.HORIZONTAL_FACING;

	public SacDeFrappeFuturBlock() {
	...
	public static void registerRenderLayer() {
		RenderTypeLookup.setRenderLayer(NoeModBlocks.SAC_DE_FRAPPE_FUTUR.get(), RenderType.getCutout());
	}
