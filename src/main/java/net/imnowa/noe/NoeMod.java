...
@Mod("noe")
public class NoeMod {
	public static final Logger LOGGER = LogManager.getLogger(NoeMod.class);
	...
	private static class NoeModFMLBusEvents {
		private final NoeMod parent;

		NoeModFMLBusEvents(NoeMod parent) {
			this.parent = parent;
		}
