...
public class TabletteGUIMenu extends Container implements Supplier<Map<Integer, Slot>> {
	...
	public TabletteGUIMenu(int id, PlayerInventory inv, PacketBuffer extraData) {
		super(NoeModMenus.TABLETTE_GUI.get(), id);
