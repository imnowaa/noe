...
public class TabletteOffGUIMenu extends Container implements Supplier<Map<Integer, Slot>> {
	...
	public TabletteOffGUIMenu(int id, PlayerInventory inv, PacketBuffer extraData) {
		super(NoeModMenus.TABLETTE_OFF_GUI.get(), id);
