...
public class RokoNoirEntity extends MonsterEntity {
	public RokoNoirEntity(FMLPlayMessages.SpawnEntity packet, World world) {
		this(NoeModEntities.ROKO_NOIR.get(), world);
	}

	public RokoNoirEntity(EntityType<RokoNoirEntity> type, World world) {
		super(type, world);
		stepHeight = 1f;
		experienceValue = 0;
		setNoAI(false);
	...
	public static AttributeModifierMap.MutableAttribute createAttributes() {
		...
		builder = builder.createMutableAttribute(Attributes.MOVEMENT_SPEED, 0.5);
